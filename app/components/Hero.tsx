      ...
      <div className='relative z-20 flex flex-1 flex-col xl:w-1/2'>
        ...
        <div className='my-11 flex flex-wrap gap-5'>
          ...
          <p className='bold-16 lg:bold-20 text-blue-70'>
            178k
            <span className='regular-16 lg:regular-20 ml-1 hover:text-blue-800 hover:underline cursor-pointer'> Excellent reviews</span>
          </p>
        </div>
      ...
      <div className='relative flex flex-1 items-start'>
        <div className='relative flex z-20  w-[268px] flex-col gap-8 rounded-3xl bg-green-90 px-7 py-8'>
              ...
              <div className='flex flex-col'>
                ...
                <p className='bold-20 text-white'>Aburi Gardens</p>
              ...
              <div className='flexBetween'>
                <div className='flex flex-col'>
                  ...
                  <p className='bold-20 text-white'>1529.35 km</p>
                </div>
                

                <div className='flex flex-col'>
                  <p className='regular-16 text-gray-20'>Duration</p>
                  <p className='bold-20 text-white'>18 hours</p>
                </div>
              </div>
